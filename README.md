...
| Pick a version | <code>curl -fsSL …/get.sh &vert; sh -s -- --version 4.9.0</code> |
...
```bash
sudo apt install ./snatch-dl_4.9.0-1_amd64.deb            # Debian, Ubuntu, Mint
sudo dnf install ./snatch-dl-4.9.0-1.x86_64.rpm           # Fedora, RHEL, openSUSE
sudo pacman -U ./snatch-dl-4.9.0-1-x86_64.pkg.tar.zst     # Arch, Manjaro
```
